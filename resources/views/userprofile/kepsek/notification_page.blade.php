...
<script>
                    ...
                    $.each(dataNotification, function(key, value){
                        ...
                        switch (value.data.status_kegiatan_id) {
                            case 3:
                                ...
                                createSpanFontElement.innerText = value.data.type_notification+" "+value.data.nama_kegiatan+" Telah diunggah oleh "+value.data.user_pj+", Silahkan Beri Keputusan terkait "+value.data.type_notification;
                            break;
                            case 6:
                                createLogoStatusElement.className= 'icon-circle bg-success';
                                createIconStatusElement.className= 'fa fa-check text-white';
                                createSpanFontElement.innerText = "Laporan Kegiatan Historis "+value.data.nama_kegiatan+" Sudah Diunggah oleh "+value.data.user_pj;
                            break;
                            default:
    ...
    $(document).on('click' , '.deleteNotification', function(e){
        ...
        window.axios.delete('/kepala-sekolah/notification/delete-notifications',{
            params:{
