                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                          ...
                          <div class="col-auto">
                            ...
                            <a href="#" class="notificationLink" id="{{ $item->id }}" data-type="{{ $item->data['type_notification'] }}" data-toggle="tooltip" data-placement="bottom" >
                          ...
                          <div class="col-auto">
                            ...
                            <a href="#" class="notificationLink" id="alreadyRead" data-id="{{ $item->id }}" data-type="{{ $item->data['type_notification'] }}" data-toggle="tooltip" data-placement="bottom">
                                <i class="fa fa-arrow-right fa-2x"></i>
                            </a>
                            <a href="#" class="ml-2 deleteNotification" id="{{ $item->id }}" data-toggle="tooltip" data-placement="bottom" ><i class="fa fa-trash fa-2x text-danger"></i></a>
                          </div>
