                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-sm-12 col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_sekolah" id="nama_sekolah" value="{{ Auth::user()->name }}" class="form-control" disabled>
                                </div>
                                <div class="form-group">
                                    {!! Form::label('username_id' , "Username ID:" ) !!}
                                    <input type="text" name="alamat_sekolah" id="alamat_sekolah" value="{{ Auth::user()->username_id }}" class="form-control" disabled>
                                </div>
                                <div class="form-group">
