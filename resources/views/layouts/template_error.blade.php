      ...
      {{-- <li class="nav-item {{ (request()->segment(2) == 'mengelola-kegiatan') ? 'active' : '' }}">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('kepsek.kelola_kegiatan.index') }}">Proposal Kegiatan</a>
            <a class="collapse-item" href="{{ route('kepsek.pengajuan_dokumentasi_kegiatan.index') }}">Dokumentasi Kegiatan</a>
          </div>
        </div>
      </li> --}}
