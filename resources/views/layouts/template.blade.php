  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #00a85a">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center">
        ...
        {{-- <div class="sidebar-brand-text mx-3 text-white">SB Admin <sup>2</sup></div> --}}
      ...
      {{-- <li class="nav-item {{ (request()->segment(2) == 'users') ? 'active' : '' }}">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Fungsi User PPK</h6>
            <a class="collapse-item" href="{{ route('admin.user.create') }}">Buat User PPK Baru</a>
            <a class="collapse-item" href="{{ route('admin.user.index') }}">Lihat Semua User PPK</a>
          </div>
        </div>
      </li> --}}
