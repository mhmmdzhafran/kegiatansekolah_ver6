...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #00a85a">
      ...
      <!-- Nav Item - Dashboard -->
      {{-- <li class="nav-item {{(request()->is('kepalasekolah-home')) ? 'active' : ''}}">
        <a class="nav-link" href="{{ url('/kepalasekolah-home') }}">
      ...
      <li class="nav-item {{(request()->segment(2) == 'mengelola-kegiatan') ? 'active' : ''}}">
        <a class="nav-link" href="{{ route('kepsek.kelola_kegiatan.index') }}">
      ...
      {{-- <li class="nav-item {{ (request()->segment(2) == 'mengelola-kegiatan') ? 'active' : '' }}">
        ...
        {{-- <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item {{(request()->segment(2) == 'mengelola-kegiatan' && request()->segment(3) == '') ? 'active' : ''}}" href="{{ route('kepsek.kelola_kegiatan.index') }}">Proposal Kegiatan</a>
          </div>
        </div> --}}
      </li>
    ...
    <li class="nav-item {{ (request()->segment(2) == 'asesmen-ppk') ? 'active' : ''}}">
        {{-- <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities"> --}}
          <a class="nav-link" href="{{ route('kepsek.asesmen.index') }}">
          <i class="fas fa-fw fa-tasks"></i>
          <span>Asesmen PPK</span>
        </a>
        {{-- <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Fungsi Asesmen:</h6>
            <a class="collapse-item" href="{{ route('kepsek.asesmen.index') }}">Asesmen PPK</a> --}}
