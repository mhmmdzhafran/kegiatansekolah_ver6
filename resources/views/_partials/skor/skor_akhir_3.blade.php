<tbody>
    ...
    {{-- @php
        // if ($item->no == $counter_limit_asesment_4) {
        //     break;
        // }
            $item->no++;
        @endphp --}}
    @if ($item->no >= $counter_limit_asesment_3 && $item->no <= $assessment_limit_kategori_3)
    ...
    <td style="background-color: grey"></td>
    <td style="background-color: grey"></td>
    <td>{{ $assessmen_internal->rerata_indikator_3 }}</td>
</tbody>